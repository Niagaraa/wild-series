 ...
 */
final class Version20191128165609 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE season ADD program_id INT DEFAULT NULL, ADD year INT NOT NULL, ADD description LONGTEXT NOT NULL');
