 ...
 */
final class Version20191125164358 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE season ADD program_id INT NOT NULL, ADD year INT NOT NULL, ADD description LONGTEXT NOT NULL');
        ...
        $this->addSql('ALTER TABLE episode ADD season_id INT NOT NULL, ADD title VARCHAR(255) NOT NULL, ADD number INT NOT NULL, ADD synopsis LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE season DROP program_id, DROP year, DROP description');
    }
}
